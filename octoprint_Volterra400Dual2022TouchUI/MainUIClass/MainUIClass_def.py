...
from MainUIClass.MainUIClasses import doorLock, activeExtruder, printerName, changeFilamentRoutine, controlScreen, displaySettings, filamentSensor, firmwareUpdatePage, getFilesAndInfo, homePage, menuPage, printLocationScreen, printRestore, printerStatus, settingsPage, settingsPage, socketConnections, softwareUpdatePage, start_keyboard, calibrationPage, networking
import mainGUI
...
class MainUIClass(QtWidgets.QMainWindow, mainGUI.Ui_MainWindow):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.activeExtruderInstance.setActiveExtruder(0)
    ...
    def setActions(self):
        ...
        self.activeExtruderInstance.connect()
