...
class ethernetSettingsPage:
    ...
    def connect(self):
        self.MainUIObj.ethStaticIpLineEdit.clicked_signal.connect(lambda: self.ethShowKeyboard(self.MainUIObj.ethStaticIpLineEdit))
        self.MainUIObj.ethStaticGatewayLineEdit.clicked_signal.connect(lambda: self.ethShowKeyboard(self.MainUIObj.ethStaticGatewayLineEdit))
